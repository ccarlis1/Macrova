...
**Owner:** You  ·  **Duration:** Week 1 (5 working days) + Week 2 buffer  ·  **Status:** Ready to build (architecture-reconciled)
...
| **nutrition** | Macro / ingredient emphasis | `high-protein`, `shrimp` | Optional |
