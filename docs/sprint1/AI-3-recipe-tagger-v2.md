...
- [ ] On generation:
  ...
  3. Unknown slugs are created with `source="llm"` (quarantined; confirmed later via FE-5).
...
- Reverse-direction: computing tags from nutrition numbers (future `high-protein` auto-tag could be nice; defer).
